        ...
        <View style={{ backgroundColor: Colors.primary, padding: 12 }}>
          ...
          >
            ...
            <View
              style={{ flexDirection: "row", alignItems: "center", gap: 10 }}
            >
              <Feather name="search" size={24} color={Colors.primaryDark} />
              <Octicons name="three-bars" size={24} color={Colors.primaryDark} />
            </View>
          </View>
        </View>
        ...
        >
          <Pressable
            ...
            style={{
              ...
              borderWidth: 1,
              borderColor:
                selectedOption == "Wash + fold" ? Colors.primary : "transparent",
            }}
          >
            <Image
          ...
          <Pressable
            ...
            style={{
              ...
              borderWidth: 1,
              borderColor:
                selectedOption == "Wash + Iron" ? Colors.primary : "transparent",
            }}
          >
            <Image
              style={{ width: 40, height: 40 }}
          ...
          <Pressable
            ...
            style={{
              ...
              borderWidth: 1,
              borderColor:
                selectedOption == "Steam Iron" ? Colors.primary : "transparent",
            }}
          >
            <Image
              style={{ width: 40, height: 40 }}
          ...
          <Pressable
            ...
            style={{
              ...
              borderWidth: 1,
              borderColor:
                selectedOption == "Dry Clean" ? Colors.primary : "transparent",
            }}
          >
            <Image
              style={{ width: 40, height: 40 }}
        ...
        <View>
          ...
          >
            <Pressable
              ...
              style={{
                padding: 10,
                backgroundColor: option == "Men" ? Colors.primary : Colors.surface,
                width: 60,
                borderRadius: 4,
              }}
            >
              <Text
                style={{
                  ...
                  fontWeight: "500",
                  textAlign: "center",
                  color: option == "Men" ? Colors.onPrimary : Colors.mutedText,
                }}
              >
                Men
              </Text>
            ...
            <Pressable
              ...
              style={{
                ...
                backgroundColor: Colors.surface,
                width: 70,
                backgroundColor: option == "Women" ? Colors.primary : Colors.surface,
                borderRadius: 4,
              }}
            >
              <Text
                style={{
                  ...
                  fontWeight: "500",
                  textAlign: "center",
                  color: option == "Women" ? Colors.onPrimary : Colors.mutedText,
                }}
              >
                Women
              </Text>
            ...
            <Pressable
              ...
              style={{
                ...
                backgroundColor: Colors.surface,
                width: 60,
                backgroundColor: option == "Kids" ? Colors.primary : Colors.surface,
                borderRadius: 4,
              }}
            >
              <Text
                style={{
                  ...
                  fontWeight: "500",
                  textAlign: "center",
                  color: option == "Kids" ? Colors.onPrimary : Colors.mutedText,
                }}
              >
                Kids
              </Text>
            ...
            <Pressable
              ...
              style={{
                padding: 10,
                backgroundColor: option == "Houseold" ? Colors.primary : Colors.surface,
                borderRadius: 4,
              }}
            >
              <Text
                style={{
                  ...
                  fontWeight: "500",
                  textAlign: "center",
                  color: option == "Houseold" ? Colors.onPrimary : Colors.mutedText,
                }}
              >
                Houseold
              </Text>
              ...
              {womenData?.map((item, index) => (
                ...
                >
                  ...
                  {cart.some((c) => c.item.id == item.id) ? (
                    ...
                    >
                      <AntDesign name="pluscircleo" size={24} color={Colors.primaryLight} />
                    </Pressable>
                  )}
                </Pressable>
              ))}
